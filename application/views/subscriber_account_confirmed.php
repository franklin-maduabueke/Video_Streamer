                    ...
                    <div class="col-md-5 offset-md-4 col-xs-10 offset-xs-1 box-shadow-2 p-0">
                        <div class="card border-grey border-lighten-3 m-0"  style="background-color:#efefef;">
                            ...
                            <div class="card-body collapse in">
                                <div id="activation-proc-result" style="padding:20px;">
                                    <?php 
                                    if ($activated == TRUE) 
                                    {?>
                                        <h3>Awwwwwww <?php echo $fullname;?> We really Missed You! xoxoxo. Welcome back! You can now Signin to your account.</h3>
                                    <?php
                                     }
                                     else {
                                         ?>
                                        <h3><?php echo $fail_reason; ?></h3>
                                        <a href="<?php echo site_url() . '/subscriber/register' ?>" class="btn btn-block btn-pink" style="margin-top:20px;">Sign Up</a>
                                        <?php
                                     }
                                     ?>
                                </div>

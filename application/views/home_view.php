...
<head>
  ...
  <body style="background-color:#141619; padding-top:0px; overflow-x:hidden; overflow-y:scroll;" id="homebody" 
    ...
    <div id="preloader-wrapper">
      ...
      <div class="loader-section section-top" style="background-color:#cc135c;"></div>
      <div class="loader-section section-bottom" style="background-color:#cc135c;"></div>
    </div>
    ...
    <!-- CSS Classes -->
    <div class="row">
      <div class="col-md-12" id="homebanner" style="text-align:center; position: relative; z-index:-2;">
        <img src="static/<?php echo $homebanner; ?>" class="image-fluid" style="max-width:100%; height:auto;" />
      </div>
    </div>
    ...
    <div class="main-menu menu-light menu-border menu-shadow menu-accordion" id="mobile-view-side-bar">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <?php
          if ($video_category && is_array($video_category))
          {
    ...
    <div class="content-body" style="padding:0px; margin:0px;" id="home-page-main-content-body">
      <?php
	  
		if (is_array($video_catalog)) {
			foreach ($video_catalog as $catalog)
			{
		  ?>
		  <div class="carouselTitle" style="margin-left: 42px; width:auto; font-weight:bold; color:#dfdfdf; font-size:19px; font-family:Helvetica, Verdana; position:relative; z-index:-1;"><?php echo $catalog['title'];?></div>
		  
		  <div class="card" style="border:none; box-shadow: none; margin:0px; background-color:transparent;">
			  <div class="card-body collapse in" style="padding-top:0px; height:auto; margin-left: 20px; padding-left: 20px;">            
					  ...
					  <div id="netflixcarouselContainer">
						...
						<div class="contain">
						  <div class="row">
							...
							?>
							  <div class="tile">
								<input type="hidden" value="<?php echo trim($video['actors']); ?>" class="video-actors" />
								<input type="hidden" value="<?php echo trim($video['directors']); ?>" class="video-directors" />
								<input type="hidden" value="<?php echo trim($video['creators']); ?>" class="video-creators" />
								<input type="hidden" value="<?php echo trim($catalog['title']); ?>" class="video-genres" />
								...
								<div class="tile__media">
									...
									<?php
									  ...
									  {
									?>
									<img class="tile__img" src="<?php echo base_url() . 'media_source/video_cover/' . $video['cover_image']; ?>" alt=""  />
									<?php
									  }
									?>

									<img class="tile__img" <?php if (strlen($video['cover_image'] > 2)) echo 'style="opacity:0;"';?> src="http://vid.ly/<?php echo trim($video['vidly_url']); ?>/poster" alt=""  />
									<img class="tile__img" style="opacity:0;" src="http://vid.ly/<?php echo trim($video['vidly_url']); ?>/poster2" alt=""  />
									<img class="tile__img" style="opacity:0;" src="http://vid.ly/<?php echo trim($video['vidly_url']); ?>/poster3" alt=""  />
								</div>

								<div class="tile__details">
								  <div class="tile__title">
									<a href="<?php echo site_url() . "/video/watch/{$video['appid']}"; ?>" style="font-weight:bold;"><?php echo trim($video['title']); ?></a>
									
									<div class="title_description"><?php echo wordwrap(trim($video['description']), 65, '<br/>'); ?></div>
    ...
    <div class="content-body hidden" style="padding:0px; margin-top:120px; top:0px;" id="home-page-search-content-body">
        <input type="hidden" id="site-base-url" value="<?php echo base_url();?>" />
        
        <div class="row" id="search_heading">
            <div class="col-md-8">
                <h3><?php 
                if ($video_category && isset($video_category))
                {
                  if (count($video_category) == 0) 
                    echo 'Search';
                  else
                    echo 'Search'; //$video_category[0]['title']'';
                }
                else
                  echo 'Search';
                ?>
